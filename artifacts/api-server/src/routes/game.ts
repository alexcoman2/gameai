...
const GAME_PROCESS_MAP: Record<string, string> = {
  ...
  "control.exe": "Control",
  // Devil May Cry series (incl. HD Collection bundles)
  "dmc.exe": "DmC: Devil May Cry",
  "devilmaycry.exe": "DmC: Devil May Cry",
  "dmc1.exe": "Devil May Cry HD Collection",
  "dmc2.exe": "Devil May Cry HD Collection",
  "dmc3.exe": "Devil May Cry 3: Dante's Awakening",
  "dmc3se.exe": "Devil May Cry 3: Special Edition",
  "devilmaycry3.exe": "Devil May Cry 3: Special Edition",
  "dmc4.exe": "Devil May Cry 4",
  "dmc4se.exe": "Devil May Cry 4: Special Edition",
  "devilmaycry4.exe": "Devil May Cry 4: Special Edition",
  "dmc5.exe": "Devil May Cry 5",
  "devilmaycry5.exe": "Devil May Cry 5",
  "dmchdcollection.exe": "Devil May Cry HD Collection",
  "nelo.exe": "Devil May Cry 5",
  "bayonetta.exe": "Bayonetta",
  "bayonetta2.exe": "Bayonetta 2",
  "bayonetta3.exe": "Bayonetta 3",
  "ninjagaiden.exe": "Ninja Gaiden: Master Collection",
  "metalgearrising.exe": "Metal Gear Rising: Revengeance",
  "mgr.exe": "Metal Gear Rising: Revengeance",
